...
<table class="table table-condensed table-bordered">
    ...
    <?php while ($payment = Arr::get($transactiondetails, "PAYMENTREQUEST_" . $payment_index . "_AMT")): ?>

        <?php $payment_details = PayPal_PaymentsPro_GetExpressCheckoutDetails::paymentrequest($transactiondetails, $payment_index) ?>    
        ...
        <?php while ($product = Arr::get($transactiondetails, "L_PAYMENTREQUEST_" . $payment_index . "_AMT$product_index")): ?>

            <?php $item_details = PayPal_PaymentsPro_GetExpressCheckoutDetails::item($transactiondetails, $payment_index, $product_index) ?>    
